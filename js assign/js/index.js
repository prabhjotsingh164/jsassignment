...
var job_title, geographic_location, annual_salary,company_name;
...
var supply=((maximum_age-current_age)*365)*amount_per_day;
...
var temp_in_celcius=43;
var convert_celcius_to_fahrenheit=(temp_in_celcius*(9/5))+ 32;
var temp_in_fahrenheit=35;
var convert_fahrenheit_to_celcius=(temp_in_fahrenheit -32)*(5/9);
